...
{#if showAbout}
  ...
  >
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-label="About ModbusLab Client"
    >
      ...
      <div class="about-body">
        ...
        <div class="about-section">
          <h3>About</h3>
          <p>
            ModbusLab Client is a professional-grade desktop Modbus master
            client purpose-built for industrial automation engineers and system
            integrators. It demonstrates a modern, production-ready approach to
            factory floor operations, IoT device management, and SCADA system
            testing.
          </p>
